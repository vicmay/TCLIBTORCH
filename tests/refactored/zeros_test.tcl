# tests/refactored/zeros_test.tcl
# Test file for refactored torch::zeros command
...
if {![llength [info commands torch::zeros]]} {
    puts "❌ Command torch::zeros not found after loading libtorchtcl.so"
    exit 1
}

# Configuration
set COMMAND_NAME "zeros"
set COMMAND_OLD "torch::zeros"
set COMMAND_NEW "torch::zeros"
